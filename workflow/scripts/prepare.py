...
from _eubucco import (
    EUBUCCO_SCHEMA,
    assign_region_batches,
    map_regions,
    needs_eubucco_metadata,
    read_plan,
)
...
def building_sources(snakemake):
    ...
    if use_eubucco:
        ...
        stats = gpd.read_parquet(metadata[1])
...
def floor_area_totals(snakemake):
    ...
    """
    # Only this preparation job needs the heavier population aggregation stack.
    import rioxarray
